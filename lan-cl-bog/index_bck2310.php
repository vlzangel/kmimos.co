...
<html> 
    ...
    <body id="waypoint">
		...
		<section class="contain_window viaje" style="background:url(img/new/bogota.jpg) center/cover no-repeat; ">
			<div class="header">
			...
			<div class="content">
				<div class="contain">
					...
					<div class="testimonials wow zoomIn">
						<div class="testimony" data-img="img/new/caregiver/bogota-1.jpg">
							<p class="title"></p>
							<p>"Me gustó mucho que mi perrito salió y entró contento. Además me mandaron fotos de como iba su cuidado."</p>
						</div>
						<div class="testimony" data-img="img/new/caregiver/bogota-2.jpg">
							<p class="title"></p>
							<p>"Quedo muy agradecida y feliz con el servicio de Kmimos, lo recomiendo ampliamente!"</p>
						</div>
					</div>
				</div>
			</div>
