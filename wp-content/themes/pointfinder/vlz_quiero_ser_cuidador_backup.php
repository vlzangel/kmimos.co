								...
								<div class="vlz_parte">
									...
									<div class="vlz_seccion">
										...
										<div class="vlz_cell50 jj_input_cell00">
											...
											<div class="vlz_sub_seccion">
												<div class="vlz_cell50">
													<input data-title="El DNI debe ser de 10 dígitos." type='number' id='ife' name='ife' class='vlz_input' min="0" placeholder='DNI' maxlength="10" required pattern="[0-9]{10}" >
												</div>
												
												<div class="vlz_cell50">
													<input data-title="Debes ingresar tu número telefónico<br>Este debe tener entre 10 y 11 dígitos." type='number' id='telefono' maxlength="11" min="0" name='telefono' class='vlz_input' placeholder='Tel&eacute;fono' required pattern="[0-9]{11}">
												</div>
											</div>
						      	...
						      	jQuery(".vlz_boton_agregar").on("click", function(){
						      		...
						      		<?php
										...
										$txts = array(
						      			...
						      			foreach ($tam as $key => $value) {
											echo "var ".$key." = jQuery(\"<div class='vlz_cell25'><input type='text' id='adicional_".$key."' name='adicional_".$key."[]' class='vlz_input' placeholder='".$value."'title='".$txts[$key]."' data-charset='num'><div class='no_error' id='error_adicional_".$key."'></div></div>\");";
