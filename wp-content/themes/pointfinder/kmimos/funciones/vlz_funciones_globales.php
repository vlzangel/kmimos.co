<?php
    ...
    function quitarAcentos($String){
        $String = preg_replace("#[äáàâãª]#i","a",$String);
        $String = preg_replace("#[ÁÀÂÃÄ]#i","A",$String);
        $String = preg_replace("#[ÍÌÎÏ]#i","I",$String);
        $String = preg_replace("#[íìîï]#i","i",$String);
        $String = preg_replace("#[éèêë]#i","e",$String);
        $String = preg_replace("#[ÉÈÊË]#i","E",$String);
        $String = preg_replace("#[óòôõöº]#i","o",$String);
        $String = preg_replace("#[ÓÒÔÕÖ]#i","O",$String);
        $String = preg_replace("#[úùûü]#i","u",$String);
        $String = preg_replace("#[ÚÙÛÜ]#i","U",$String);
    ...
    function stripAccents($string){
        ...
        $str  = (array) $string;
        $mal  = (array) "àáâãäçèéêëìíîïñòóôõöùúûüýÿÀÁÂÃÄÇÈÉÊËÌÍÎÏÑÒÓÔÕÖÙÚÛÜÝ";
        $bien = (array) "aaaaaceeeeiiiinooooouuuuyyAAAAACEEEEIIIINOOOOOUUUUY";

        $t = count($mal);

        for ($i=0; $i < $t; $i++) {
            $string = str_replace($mal[$i], $bien[$i], $string);
        }
