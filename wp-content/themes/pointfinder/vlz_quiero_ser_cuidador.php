							...
							<div class="vlz_parte">
								...
								<div class="">
									...
									<div id="kmimos_datos_personales" class="vlz_cell50 jj_input_cell00">
										...
										<div class="vlz_sub_seccion">
											<div class="vlz_cell50">
												<input data-title="Ingresar el DNI." data-help="El DNI debe ser de al menos 7" type='number' id='ife' name='ife' class='vlz_input' placeholder='Cédula' min=7 pattern="^\d{7}$" >
											</div>
