...
class WP_Import extends WP_Importer {
	...
	function import_end() {
		...
		echo  esc_html__( 'Demo content done.', 'pointfindert2d' ) . ' <a href="' . admin_url() . '">' . esc_html__( 'Have fun!', 'pointfindert2d' ) . '</a>' . '<br/>';
...
<?php }; ?>
	...
	<p class="submit"><input type="submit" class="button" value="<?php esc_html_e( 'Submit', 'wordpress-importer' ); ?>" /></p>
</form>
<?php
	}
