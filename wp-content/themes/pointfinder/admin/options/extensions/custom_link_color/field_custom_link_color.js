...
(function( $ ) {
    ...
    redux.field_objects.extension_custom_link_color = redux.field_objects.extension_custom_link_color || {};
    ...
    redux.field_objects.extension_custom_link_color.init = function( selector ) {

        if ( !selector ) {
            selector = $( document ).find( '.redux-container-extension_custom_link_color' );
        }
