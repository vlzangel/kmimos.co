    ...
    <div class="wpb_wrapper">
        ...
        <div class="teaser_grid_container">
            ...
            <ul class="categories_filter vc_clearfix">
                <li class="active"><a href="#" data-filter="*"><?php esc_html_e('All', 'pointfindert2d') ?></a></li>
            ...
            <ul class="wpb_thumbnails wpb_thumbnails-fluid vc_clearfix" data-layout-mode="<?php echo $grid_layout_mode ?>">
                ...
                <?php
                    ...
                    ?>
                    <?php  
                    $replaced_vars = apply_filters(VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, $li_span_class, 'vc_teaser_grid_li').$post->categories_css;
                    $replaced_vars = preg_replace('/vc_span(\d{1,2})/', 'col-lg-$1 col-md-$1', $replaced_vars);
                    ?>
                <li class="isotope-item <?php echo $replaced_vars;?> "<?php echo $block_style ?>>
                    <div class="vc-pf-inner isotope-inner" <?php echo $itemboxstyle?>>
                ...
                <?php endforeach; ?>
                <?php }else{ ?>
                <li class="<?php echo $this->spanClass(1); ?>"><?php esc_html_e("Nothing found." , "pointfindert2d") ?></li>
                <?php }; ?>
            </ul>
        </div>
