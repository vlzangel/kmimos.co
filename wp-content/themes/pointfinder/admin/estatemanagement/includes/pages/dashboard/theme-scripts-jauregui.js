		            ...
		            success:function(data){
						...
						$('#pf-ajax-register-button').click(function(){
							...
							if ($.isEmptyObject($.pfAjaxUserSystemVars2)) {
								...
								// $.pfAjaxUserSystemVars2.username_err2 = 'Por favor, introduzca entre 4 y 15 caracteres de Nombre de Usuario.';
							...
							form.validate({
								  ...
								  rules:{
								      ...
								      maxlength:8,
								      // rangelength: [4, 8],
								      pattern:"^([a-z]+[0-9]{0,4}){4,8}$"//Usuario Valido
								    },
								  	email:{
								  		required:true,
								  		email:true								  	}
								  ...
								  messages:{
								  	username:{
									  	...
									  	//minlength:"Por favor, introduzca minimo 4 caracteres de Nombre de Usuario.",
									  	maxlength:"Por favor, introduzca maximo 8 caracteres de Nombre de Usuario.",
									  	minlength:"Por favor, introduzca minimo 4 caracteres de Nombre de Usuario.",
								  	},
								  	email: {
...
***************************************************************************************************************/
	...
	$(document).ready(function($) {
		...
		$('a.edit').addClass('button'); /*Jaurgeui*/
	});
