										...
										<li class="col-lg-4 col-md-6 col-sm-6 col-xs-12 wpfitemlistdata isotope-item text-center">
											<div class="pflist-item" style="background-color:#ffffff;">  
												<div class="pflist-item-inners">
													...
													<a href="'.$params['detail_url'].$pet.'"><h3>'. get_the_title($pet).'</h3></a>
													<br>
													<img src="'.get_option('siteurl').'/wp-content/plugins/kmimos/assets/rating/100.png" width="50px">
												</div>
											</div>
										</li>';
									}
					...
					case 'mypet':
						...
						**/
                        ...
                        $this->FieldOutput .= '
                            		...
                            		$razas = $wpdb->get_results("SELECT * FROM razas");
                        ...
                        $this->FieldOutput .= '
                                   <div class="cell25">
		                               <section>
		                                    ...
		                                    <label class="lbl-ui">
		                                    	<input type="date" name="pet_birthdate" class="input datepicker" value="'.$current_pet['birthdate'].'" />
		                                    </label>
		                               </section>
		                           </div>';
                        $this->FieldOutput .= ' 
...
//                       $this->ScriptOutput = 'jQuery(".datepicker").datepicker();';
					...
					case 'myservices':
						/**
						*Start: Services list Page Content
						**/
                        ...
                        // $this->FieldOutput .= '<div class="lista_servicios" data-user="'.$user_id.'"><ul>';
                        // if($count>0) {
                        //     $services = explode(",",$params['list']);
                        //     $this->FieldOutput .= '<div class="inside">';
                        //     $this->FieldOutput .= '<ul>';
                        //     foreach($services as $service){ 
                        //         $this->FieldOutput .= '<li><a href="'.$params['detail_url'].$service.'">'. get_the_title($service).'</a></li>';
                        //     }
                        //     $this->FieldOutput .= '</ul>';
                        //     $this->FieldOutput .= '<br><p>Total: '.count($services).' servicios</p>';
                        //     $this->FieldOutput .= '</div>';
                        // }
                        // else $this->FieldOutput .=  '<p>No tienes ninguna servicio cargado</p>';
                        // $this->FieldOutput .=  '</ul><br></div>';
                        $this->ScriptOutput .= "
                        ...
                        foreach ($precios_hospedaje as $key => $value) {
                        	$hospedaje .= "
                        		<div class='vlz_celda_25'>
                        			<label>".$tam[$key]."</label>
                        			<input type='number' data-charset='num' class='vlz_input' id='hospedaje_".$key."' name='hospedaje_".$key."' value='".$value."' />
                    			</div>
                        	";
                        }
                        ...
                        foreach ($adicionales_extra as $key => $value) {
                        	$adicionales_extra_str .= "
                        		<div class='vlz_celda_20'>
                        			<label>".$value."</label>
                        			<input type='number' data-charset='num'  class='vlz_input' id='adicional_".$key."' name='adicional_".$key."' value='".$adicionales[$key]."' />
                    			</div>
                        	";
                        }
                    	...
                    	foreach ($rutas as $slug => $valor) {
                    		$temp .= "
                        		<div class='vlz_celda_33'>
                        			<label>".$valor."</label>
                        			<input type='number' data-charset='num'  class='vlz_input' id='transportacion_sencilla_".$slug."' name='transportacion_sencilla_".$slug."' value='".$adicionales['transportacion_sencilla'][$slug]."' />
                    			</div>
                			";
                    	}
                    	$transporte_sencillo_str .= "
                    	...
                    	foreach ($rutas as $slug => $valor) {
                    		$temp .= "
                        		<div class='vlz_celda_33'>
                        			<label>".$valor."</label>
                        			<input type='number' class='vlz_input' data-charset='num'  id='transportacion_redonda_".$slug."' name='transportacion_redonda_".$slug."' value='".$adicionales['transportacion_redonda'][$slug]."' />
                    			</div>
                			";
                    	}
                    	$transporte_redondo_str .= "
...
.error{
    ...
    border-color: #ebccd1;
                        	...
                        	<div>
                        		<div class=\"hidden alertas alertas-info\" style=\"padding:10px;margin-bottom:10px;margin-top:5px;\">
									<small> 
						...
						/**
						*End: Services list Page Content
						**/
					break;
						...
						**/
								...
								if( $user->roles[0] == "vendor" ){
									...
									if( $cuidador->portada != '0' ){
										$imagen = get_home_url()."/wp-content/uploads/cuidadores/avatares/".$cuidador->id."/{$referred}.jpg";
									}else{
										$imagen = get_template_directory_uri().'/images/noimg.png';
									}
								}else{
									$user_id_tipo = $user_id;
									if($usermetaarr['user_photo'][0] == 0){
										$imagen = get_template_directory_uri().'/images/noimg.png';
									}else{
										$imagen = get_home_url()."/wp-content/uploads/avatares_clientes/".$user_id."/{$referred}.jpg";
									}
								}
								...
								$this->FieldOutput .= '
		                           ...
		                           <!--<div class="col6 last">-->
		                            ...
		                            <div class="jj_dash2_cel50">
		                           	...
		                           	<div class="jj_dash_cel50">
			                           	<section>
		                                    ...
		                                    <label class="lbl-ui">
												...
												<ul>
													<li>Una letra mayuscula
													<li>Una letra minuscula
													<li>Un número
													<li>Uno de estos caracteres especiales (- * #)
													<li>Y una longitud minima de 6 caracteres
												</ul>" 
		                           	...
		                           	<div class="jj_dash_cel50">
		                                <section class="pswd_info_pc">
			                               	<div id="pswd_info">
											   	<ul>
											      	<li id="letter"><strong>La contraseña debe contener al menos</strong></li>
											      	<li id="letter">Una letra mayúscula</li>
											      	<li id="capital">Una letra minúscula</li>
											      	<li id="number">Un número</strong></li>
											      	<li id="number">Una longitud mínima de 6 caracteres</li>
											      	<li id="length">Y al final debe llevar  #</li>
											      	<li id="equals"><strong>Las contraseñas deben ser iguales</strong></li>
											   	</ul>
											</div>
		                               	</section>
