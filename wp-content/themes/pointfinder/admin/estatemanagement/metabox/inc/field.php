...
if ( ! class_exists( 'RWMB_Field ' ) )
{
	class RWMB_Field
	{
		...
		{
			return '<a href="#" class="rwmb-button button-primary add-clone">' . esc_html__( '+', 'meta-box' ) . '</a>';
		}
		...
		{
			return '<a href="#" class="rwmb-button button remove-clone">' . esc_html__( '&#8211;', 'meta-box' ) . '</a>';
		}
