				...
				foreach ($pendientes as $key => $value) {
					$resultados .= "
						<tr>
							...
							<td style='text-align: center; width: 85px; font-weight: 600;'>{$value['STA']}</td>
							<td style='text-align: right; width: 166px;'>
								{$value['PDF']}
								<a class='btn_ver'
									href='".get_home_url()."/mi-cuenta/view-order/".($id_reserva+1)."/'
									style='   
										font-weight: 600;
									    background: #54c8a7;
									    padding: 3px 5px;
								...
								<a class='btn_cancelar'
									href='".get_home_url()."/wp-content/plugins/kmimos/orden.php?o=".($id_reserva)."&s=0'
									style='   
										font-weight: 600;
									    background: #e80000;
									    padding: 3px 5px;
