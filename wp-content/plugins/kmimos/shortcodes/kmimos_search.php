...
<?php
    ...
    $ESTADOS = '
       ...
       <option value="18">BUENAVENTURA</option>
       <option value="2">CALI</option>
       <option value="5">CARTAGENA</option>
       <option value="6">CUCUTA</option>
       <option value="27">ENVIGADO</option>
       <option value="8">IBAGUE</option>
       <option value="26">ITAGUI</option>
       <option value="19">MANIZALES</option>
       <option value="1">MEDELLIN</option>
       <option value="16">MONTERIA</option>
       <option value="20">NEIVA</option>
       <option value="21">PALMIRA</option>
       <option value="17">PASTO</option>
       <option value="13">PEREIRA</option>
       <option value="24">POPAYAN</option>
       <option value="25">RIOHACHA</option>
       <option value="12">SANTA MARTA</option>
       <option value="23">SINCELEJO</option>
    ...
    global $wpdb;
    $states = $wpdb->get_results("SELECT * FROM states WHERE country_id = '1' ORDER BY name ASC");
    //$ESTADOS = '<option value="">Seleccione un estado</option>';
    foreach($states as $state) {
        //$ESTADOS .= '<option value="'.$state->id.'">'.$state->name.'</option>';
    }
