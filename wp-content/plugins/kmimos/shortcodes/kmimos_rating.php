...
//print_r($current_user); 
    ...
    *   Inserta las valuaciones y actualiza el rating del cuidador
...
*   Verifica que la reserva se haya completado, que no haya sido valorada y que pertenezca al usuario que inició sesión

*/

$reserva = get_post($post_id);

// if($reserva->post_status != 'complete') {

//     echo '<h1>La reserva seleccionada no ha sido completada</h1>';

//     echo '<a href="'.get_home_url().'/perfil-usuario/?ua=invoices">Volver a mis compras</a>';
...
if(get_post_meta($post_id, 'customer_comment', true) != '') {
    ...
    if($reserva->post_author != $user_id) {
        ...
        /*
        *   Obtiene los datos del servicio de reserva
        */
...
<?php 
for($i=1;$i<=5;$i++){ ?>
<div class="select_rate cuidado" data-rate="<?php echo $i;?>" data-section="cuidado"><label for="cuidado_<?php echo $i;?>"><h4><?php echo $i;?></h4></label><br><input type="radio" id="cuidado_<?php echo $i;?>" name="cuidado" value="<?php echo $i;?>" class="huesito"><br><?php echo $vacio;?></div>
<?php    
} ?>
</div><hr>
...
<div class="reset_rate puntualidad" data-section="puntualidad"><label for="puntualidad_0"><h4>No Aplica</h4></label><br><input type="radio" id="puntualidad_0" name="puntualidad" value="0" checked></div>
<?php 
for($i=1;$i<=5;$i++){ ?>
<div class="select_rate puntualidad" data-rate="<?php echo $i;?>" data-section="puntualidad"><label for="puntualidad_<?php echo $i;?>"><h4><?php echo $i;?></h4></label><br><input type="radio" id="puntualidad_<?php echo $i;?>" name="puntualidad" value="<?php echo $i;?>" class="huesito"><br><?php echo $vacio;?></div>
<?php    
} ?>
</div><hr>
...
<div class="reset_rate limpieza" data-section="limpieza"><label for="limpieza_0"><h4>No Aplica</h4></label><br><input type="radio" id="limpieza_0" name="limpieza" value="0" checked></div>
<?php 
for($i=1;$i<=5;$i++){ ?>
<div class="select_rate limpieza" data-rate="<?php echo $i;?>" data-section="limpieza"><label for="limpieza_<?php echo $i;?>"><h4><?php echo $i;?></h4></label><br><input type="radio" id="limpieza_<?php echo $i;?>" name="limpieza" value="<?php echo $i;?>" class="huesito"><br><?php echo $vacio;?></div>
<?php    
} ?>
</div><hr>
...
<div class="reset_rate confianza" data-section="confianza"><label for="confianza_0"><h4>No Aplica</h4></label><br><input type="radio" id="confianza_0" name="confianza" value="0" checked></div>
<?php 
for($i=1;$i<=5;$i++){ ?>
<div class="select_rate confianza" data-rate="<?php echo $i;?>" data-section="confianza"><label for="confianza_<?php echo $i;?>"><h4><?php echo $i;?></h4></label><br><input type="radio" id="confianza_<?php echo $i;?>" name="confianza" value="<?php echo $i;?>" class="huesito"><br><?php echo $vacio;?></div>
<?php    
} ?>
</div><hr>
