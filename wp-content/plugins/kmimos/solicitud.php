<?php
	...
	/*	Sugeridos 	*/
	    ...
	    foreach ($sugeridos as $key => $cuidador) {
			...
			if( file_exists(ABSPATH."wp-content/uploads/avatares/".$cuidador_id."/{$name_photo}") ){
				$img = get_home_url()."/wp-content/uploads/avatares/".$cuidador_id."/{$name_photo}";
			}elseif( file_exists(ABSPATH."wp-content/uploads/avatares/".$cuidador_id."/0.jpg") ){
