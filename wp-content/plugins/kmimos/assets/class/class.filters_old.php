...
jQuery(document).ready(document).ready(function() {
	...
	var valorMinimoExperiencia = <?php echo $rangos->expermin; ?>;

	var valorMaximoExperiencia = <?php echo $rangos->expermax; ?>;
	...
	var valorMinimoValoracion = <?php echo $rangos->valormin; ?>;

	var valorMaximoValoracion = <?php echo $rangos->valormax; ?>;
...
<div class="panel">
    ...
    <div id="rango_experiencia_main" style="margin: 10px;">
        ...
        <input type="hidden" id="experiencia_minima" name="experiencia_minima" value="<?php echo $rangos->expermin; ?>">

        <input type="hidden" id="experiencia_maxima" name="experiencia_maxima" value="<?php echo $rangos->expermax; ?>">
    ...
    <div id="rango_valoracion_main" style="margin: 10px;">
        ...
        <input type="hidden" id="valoracion_minima" name="valoracion_minima" value="<?php echo $rangos->valormin; ?>">

        <input type="hidden" id="valoracion_maxima" name="valoracion_maxima" value="<?php echo $rangos->valormax; ?>">
