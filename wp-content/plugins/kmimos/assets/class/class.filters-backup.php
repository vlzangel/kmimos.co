...
<?php
	...
	public function widget($args, $instance){
        ...
        $adicionales = (isset($_GET['servicio_adicionales']))? $_GET['servicio_adicionales']:array();
...
jQuery(document).ready(document).ready(function() {
    ...
    var urlSever = get_home_url().'/wp-content/plugins/kmimos/app-server.php';
...
<div class="panel">
    ...
    <ul>
       ...
       <li><input type="checkbox" id="adicional_bano" name="servicio_adicional[]" value="veterinario"<?php if(in_array('bano_adic',$adicionales)) echo 'checked="checked"'; ?>><label for="adicional_bano" class="lbl-ui select">Baño y Secado (Serv. Adic.)</label></li>

       <li><input type="checkbox" id="servicio_veterinario" name="servicio_adicional[]" value="veterinario"<?php if(in_array('veterinario',$adicionales)) echo 'checked="checked"'; ?>><label for="servicio_veterinario" class="lbl-ui select">Visita al Veterinario</label></li>
