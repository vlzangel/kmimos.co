...
d.action;var e=!!window.sessionStorage.getItem("_mpcehash"),f;b?f=this.nb(a,window.location.hash):e?(f=this.nb(a,window.sessionStorage.getItem("_mpcehash")),window.sessionStorage.removeItem("_mpcehash")):f=JSON.parse(window.sessionStorage.getItem("editorParams")||"{}");return f.projectToken&&a.c("token")===f.projectToken?(this.Dc(a,f),m):r}catch(j){return r}},Dc:function(a,b){if(!window._mpEditorLoaded){window._mpEditorLoaded=m;var c="?_ts="+(new Date).getTime(),e=a.c("app_host")+"/site_media";this.Ec(-1<
a.c("app_host").indexOf(".dev.mixpanel.org")?e+"/compiled/reports/collect-everything/editor.js"+c:e+"/bundle-webpack/reports/collect-everything/editor.min.js"+c,function(){window.mp_load_editor(b)});return m}return r},Zc:function(a,b,d){for(var b=!c.d(b)?b:10,d=!c.d(d)?d:10,e=0,f=0;f<a.length;f++)e+=a.charCodeAt(f);return e%b<d},dd:function(){return c.bb(document.querySelectorAll)}};c.Cb(F);c.od(F);var L,s,Y="__mps,__mpso,__mpa,__mpap,__mpu,$people_distinct_id,__alias,__cmpns,__timers".split(",");
w="https:"===document.location.protocol?"https://":"http://";var K=window.XMLHttpRequest&&"withCredentials"in new XMLHttpRequest,Q=!K&&-1===t.indexOf("MSIE")&&-1===t.indexOf("Mozilla"),Z={api_host:w+"api.mixpanel.com",app_host:w+"mixpanel.com",autotrack:m,cdn:w+"cdn.mxpnl.com",cross_subdomain_cookie:m,persistence:"cookie",persistence_name:"",cookie_name:"",loaded:B(),store_google:m,save_referrer:m,test:r,verbose:r,img:r,track_pageview:m,debug:r,track_links_timeout:300,cookie_expiration:365,upgrade:r,
disable_persistence:r,disable_cookie:r,secure_cookie:r,ip:m,property_blacklist:[]},P=r;x.prototype.wa=B();x.prototype.Wa=B();x.prototype.Sa=B();x.prototype.U=function(a){this.Rb=a;return this};x.prototype.I=function(a,b,d,e){var f=this,j=c.Xc(a);if(0===j.length)k.error("The DOM query ("+a+") returned 0 elements");else return c.a(j,function(a){c.o(a,this.Tb,function(a){var c={},j=f.wa(d,this),g=f.Rb.c("track_links_timeout");f.Wa(a,this,c);window.setTimeout(f.$b(e,j,c,m),g);f.Rb.I(b,j,f.$b(e,j,c))})},
this),m};x.prototype.$b=function(a,b,c,e){var e=e||r,f=this;return function(){if(!c.Pc)c.Pc=m,a&&a(e,b)===r||f.Sa(b,c,e)}};x.prototype.wa=function(a,b){return"function"===typeof a?a(b):c.extend({},a)};c.Nb(C,x);C.prototype.wa=function(a,b){var c=C.xd.wa.apply(this,arguments);if(b.href)c.url=b.href;return c};C.prototype.Wa=function(a,b,c){c.Sb=2===a.which||a.metaKey||a.ctrlKey||"_blank"===b.target;c.href=b.href;c.Sb||a.preventDefault()};C.prototype.Sa=function(a,b){b.Sb||setTimeout(function(){window.location=
b.href},0)};c.Nb(I,x);I.prototype.Wa=function(a,b,c){c.element=b;a.preventDefault()};I.prototype.Sa=function(a,b){setTimeout(function(){b.element.submit()},0)};o.prototype.ha=function(){var a={};c.a(this.props,function(b,d){c.Lb(Y,d)||(a[d]=b)});return a};o.prototype.load=function(){if(!this.disabled){var a=this.v.parse(this.name);a&&(this.props=c.extend({},a))}};o.prototype.Dd=function(a){var b=a.upgrade,d;if(b)d="mp_super_properties","string"===typeof b&&(d=b),b=this.v.parse(d),this.v.remove(d),
this.v.remove(d,m),b&&(this.props=c.extend(this.props,b.all,b.events));if(!a.cookie_name&&"mixpanel"!==a.name&&(d="mp_"+a.token+"_"+a.name,b=this.v.parse(d)))this.v.remove(d),this.v.remove(d,m),this.F(b);this.v===c.localStorage&&(b=c.cookie.parse(this.name),c.cookie.remove(this.name),c.cookie.remove(this.name,m),b&&this.F(b))};o.prototype.save=function(){this.disabled||(this.qc(),this.v.set(this.name,c.na(this.props),this.Xa,this.Ua,this.Vb))};o.prototype.remove=function(){this.v.remove(this.name,
r);this.v.remove(this.name,m)};o.prototype.clear=function(){this.remove();this.props={}};o.prototype.F=function(a,b,d){return c.j(a)?("undefined"===typeof b&&(b="None"),this.Xa="undefined"===typeof d?this.Gb:d,c.a(a,function(a,c){if(!this.props[c]||this.props[c]===b)this.props[c]=a},this),this.save(),m):r};o.prototype.ia=function(a,b){return c.j(a)?(this.Xa="undefined"===typeof b?this.Gb:b,c.extend(this.props,a),this.save(),m):r};o.prototype.Ca=function(a){a in this.props&&(delete this.props[a],this.save())};
o.prototype.qc=c.l(function(){var a=this.props.__cmpns,b=z?6E4:36E5;if(a){for(var d in a)1*new Date-a[d]>b&&delete a[d];c.V(a)&&delete this.props.__cmpns}});o.prototype.Cd=function(){if(!this.Eb)this.F(c.info.Qc()),this.Eb=m};o.prototype.dc=function(a){this.ia(c.info.qd(a))};o.prototype.jb=function(a){this.F({$initial_referrer:a||"$direct",$initial_referring_domain:c.info.Ub(a)||"$direct"},"")};o.prototype.bd=function(){return c.za({$initial_referrer:this.props.$initial_referrer,$initial_referring_domain:this.props.$initial_referring_domain})};
o.prototype.cc=function(a){this.Gb=this.Xa=a.cookie_expiration;this.sd(a.disable_persistence);this.rd(a.cross_subdomain_cookie);this.ud(a.secure_cookie)};o.prototype.sd=function(a){(this.disabled=a)&&this.remove()};o.prototype.rd=function(a){if(a!==this.Ua)this.Ua=a,this.remove(),this.save()};o.prototype.ad=function(){return this.Ua};o.prototype.ud=function(a){if(a!==this.Vb)this.Vb=a?m:r,this.remove(),this.save()};o.prototype.A=function(a,b){var d=this.La(a),e=b[a],f=this.Z("$set"),j=this.Z("$set_once"),
g=this.Z("$add"),i=this.Z("$union"),h=this.Z("$append",[]);"__mps"===d?(c.extend(f,e),this.S("$add",e),this.S("$union",e)):"__mpso"===d?c.a(e,function(a,b){b in j||(j[b]=a)}):"__mpa"===d?c.a(e,function(a,b){b in f?f[b]+=a:(b in g||(g[b]=0),g[b]+=a)},this):"__mpu"===d?c.a(e,function(a,b){c.isArray(a)&&(b in i||(i[b]=[]),i[b]=i[b].concat(a))}):"__mpap"===d&&h.push(e);k.log("MIXPANEL PEOPLE REQUEST (QUEUED, PENDING IDENTIFY):");k.log(b);this.save()};o.prototype.S=function(a,b){var d=this.R(a);c.d(d)||
...
this.props.__timers=b;this.save()};o.prototype.md=function(a){var b=(this.props.__timers||{})[a];c.d(b)||(delete this.props.__timers[a],this.save());return b};var g;h.prototype.U=function(a,b,d){if(c.d(d))k.error("You must name your new library: init(token, config, name)");else if("mixpanel"===d)k.error("You must initialize the main mixpanel object right after you include the Mixpanel js snippet");else return a=H(a,b,d),s[d]=a,a.sa(),a};h.prototype.Na=function(a,b,d){this.__loaded=m;this.config={};
this.Wb(c.extend({},Z,b,{name:d,token:a,callback_fn:("mixpanel"===d?d:"mixpanel."+d)+"._jsc"}));this._jsc=B();this.Ia=[];this.Ja=[];this.Ha=[];this.P={disable_all_events:r,identify_called:r};this.persistence=this.cookie=new o(this.config);this.F({distinct_id:c.kb()},"")};h.prototype.sa=function(){this.c("loaded")(this);this.c("track_pageview")&&this.ac()};h.prototype.oc=function(){c.a(this.Ia,function(a){this.Qa.apply(this,a)},this);c.a(this.Ja,function(a){this.p.apply(this,a)},this);delete this.Ia;
delete this.Ja};h.prototype.Qa=function(a,b){if(this.c("img"))return k.error("You can't use DOM tracking functions with img = true."),r;if(!P)return this.Ia.push([a,b]),r;var c=(new a).U(this);return c.I.apply(c,b)};h.prototype.ta=function(a,b){if(c.d(a))return n;if(K)return function(c){a(c,b)};var d=this._jsc,e=""+Math.floor(1E8*Math.random()),f=this.c("callback_fn")+"["+e+"]";d[e]=function(c){delete d[e];a(c,b)};return f};h.prototype.p=function(a,b,d){if(Q)this.Ja.push(arguments);else{var e=this.c("verbose");
b.verbose&&(e=m);this.c("test")&&(b.test=1);e&&(b.verbose=1);this.c("img")&&(b.img=1);if(!K)if(d)b.callback=d;else if(e||this.c("test"))b.callback="(function(){})";b.ip=this.c("ip")?1:0;b._=(new Date).getTime().toString();a+="?"+c.ic(b);if("img"in b){var f=document.createElement("img");f.src=a;document.body.appendChild(f)}else if(K)try{var j=new XMLHttpRequest;j.open("GET",a,m);j.withCredentials=m;j.onreadystatechange=function(){if(4===j.readyState)if(200===j.status)d&&(e?d(c.ma(j.responseText)):
d(Number(j.responseText)));else{var a="Bad HTTP status: "+j.status+" "+j.statusText;k.error(a);d&&(e?d({status:0,error:a}):d(0))}};j.send(n)}catch(g){k.error(g)}else{f=document.createElement("script");f.type="text/javascript";f.async=m;f.defer=m;f.src=a;var i=document.getElementsByTagName("script")[0];i.parentNode.insertBefore(f,i)}}};h.prototype.Ka=function(a){function b(a,b){c.a(a,function(a){this[a[0]].apply(this,a.slice(1))},b)}var d,e=[],f=[],j=[];c.a(a,function(a){a&&(d=a[0],"function"===typeof a?
a.call(this):c.isArray(a)&&"alias"===d?e.push(a):c.isArray(a)&&-1!==d.indexOf("track")&&"function"===typeof this[d]?j.push(a):f.push(a))},this);b(e,this);b(f,this);b(j,this)};h.prototype.push=function(a){this.Ka([a])};h.prototype.disable=function(a){"undefined"===typeof a?this.P.Uc=m:this.Ha=this.Ha.concat(a)};h.prototype.I=function(a,b,d){"function"!==typeof d&&(d=B());if(c.d(a))k.error("No event name provided to mixpanel.track");else if(this.ob(a))d(0);else{b=b||{};b.token=this.c("token");var e=
this.persistence.md(a);c.d(e)||(b.$duration=parseFloat((((new Date).getTime()-e)/1E3).toFixed(3)));this.persistence.dc(document.referrer);this.c("store_google")&&this.persistence.Cd();this.c("save_referrer")&&this.persistence.jb(document.referrer);b=c.extend({},c.info.ha(),this.persistence.ha(),b);try{if(this.c("autotrack")&&"mp_page_view"!==a&&"$create_alias"!==a)b=c.extend({},b,this.D),this.D={$__c:0},c.cookie.set("mp_"+this.c("name")+"__c",0,1,m)}catch(f){k.error(f)}e=this.c("property_blacklist");
c.isArray(e)?c.a(e,function(a){delete b[a]}):k.error("Invalid value for property_blacklist config: "+e);a=c.truncate({event:a,properties:b},255);e=c.na(a);e=c.Ab(e);k.log("MIXPANEL REQUEST:");k.log(a);this.p(this.c("api_host")+"/track/",{data:e},this.ta(d,a));return a}};h.prototype.ac=function(a){if(c.d(a))a=document.location.href;this.I("mp_page_view",c.info.kd(a))};h.prototype.Bd=function(){return this.Qa.call(this,C,arguments)};h.prototype.Ad=function(){return this.Qa.call(this,I,arguments)};h.prototype.yd=
function(a){c.d(a)?k.error("No event name provided to mixpanel.time_event"):this.ob(a)||this.persistence.td(a)};h.prototype.ia=function(a,b){this.persistence.ia(a,b)};h.prototype.F=function(a,b,c){this.persistence.F(a,b,c)};h.prototype.Ca=function(a){this.persistence.Ca(a)};h.prototype.Pa=function(a,b){var c={};c[a]=b;this.ia(c)};h.prototype.Za=function(a,b,c,e,f,j){a!==this.T()&&a!==this.xa("__alias")&&(this.Ca("__alias"),this.Pa("distinct_id",a));this.lb(this.T());this.P.$a=m;this.people.sc(b,c,
e,f,j)};h.prototype.reset=function(){this.persistence.clear();this.P.$a=r;this.F({distinct_id:c.kb()},"")};h.prototype.T=function(){return this.xa("distinct_id")};h.prototype.Nc=function(a,b){if(a===this.xa("$people_distinct_id"))return k.ca("Attempting to create alias for existing People user - aborting."),-2;var d=this;c.d(b)&&(b=this.T());if(a!==b)return this.Pa("__alias",a),this.I("$create_alias",{alias:a,distinct_id:b},function(){d.Za(a)});k.error("alias matches current distinct_id - skipping api call.");
this.Za(a);return-1};h.prototype.hd=function(a){this.Pa("mp_name_tag",a)};h.prototype.Wb=function(a){if(c.j(a))c.extend(this.config,a),this.c("persistence_name")||(this.config.persistence_name=this.config.cookie_name),this.c("disable_persistence")||(this.config.disable_persistence=this.config.disable_cookie),this.persistence&&this.persistence.cc(this.config),z=z||this.c("debug")};h.prototype.c=function(a){return this.config[a]};h.prototype.xa=function(a){return this.persistence.props[a]};h.prototype.toString=
function(){var a=this.c("name");"mixpanel"!==a&&(a="mixpanel."+a);return a};h.prototype.ob=function(a){return c.Ob(t)||this.P.Uc||c.Lb(this.Ha,a)};h.prototype.lb=function(a){if(a&&!this.P.$a&&!this.c("disable_notifications")){k.log("MIXPANEL NOTIFICATION CHECK");var b=this;this.p(this.c("api_host")+"/decide/",{verbose:m,version:"2",lib:"web",token:this.c("token"),distinct_id:a},this.ta(function(a){a.notifications&&0<a.notifications.length&&b.yb.call(b,a.notifications[0])}))}};h.prototype.yb=function(a){(new g(a,
this)).show()};p.prototype.Na=function(a){this.e=a};p.prototype.set=function(a,b,d){var e={},f={};c.j(a)?(c.a(a,function(a,b){this.$(b)||(f[b]=a)},this),d=b):f[a]=b;this.ra("save_referrer")&&this.e.persistence.jb(document.referrer);f=c.extend({},c.info.ld(),this.e.persistence.bd(),f);e.$set=f;return this.p(e,d)};p.prototype.Xb=function(a,b,d){var e={},f={};c.j(a)?(c.a(a,function(a,b){this.$(b)||(f[b]=a)},this),d=b):f[a]=b;e.$set_once=f;return this.p(e,d)};p.prototype.Mb=function(a,b,d){var e={},f=
{};c.j(a)?(c.a(a,function(a,b){this.$(b)||(isNaN(parseFloat(a))?k.error("Invalid increment value passed to mixpanel.people.increment - must be a number"):f[b]=a)},this),d=b):(c.d(b)&&(b=1),f[a]=b);e.$add=f;return this.p(e,d)};p.prototype.append=function(a,b,d){var e={},f={};c.j(a)?(c.a(a,function(a,b){this.$(b)||(f[b]=a)},this),d=b):f[a]=b;e.$append=f;return this.p(e,d)};p.prototype.bc=function(a,b,d){var e={},f={};c.j(a)?(c.a(a,function(a,b){this.$(b)||(f[b]=c.isArray(a)?a:[a])},this),d=b):f[a]=
c.isArray(b)?b:[b];e.$union=f;return this.p(e,d)};p.prototype.zd=function(a,b,d){if(!c.gd(a)&&(a=parseFloat(a),isNaN(a))){k.error("Invalid value passed to mixpanel.people.track_charge - must be a number");return}return this.append("$transactions",c.extend({$amount:a},b),d)};p.prototype.Rc=function(a){return this.set("$transactions",[],a)};p.prototype.Tc=function(){if(this.sb())return this.p({$delete:this.e.T()});k.error("mixpanel.people.delete_user() requires you to call identify() first")};p.prototype.toString=
function(){return this.e.toString()+".people"};p.prototype.p=function(a,b){a.$token=this.ra("token");a.$distinct_id=this.e.T();var d=c.Ib(a),e=c.truncate(d,255),d=c.na(d),d=c.Ab(d);if(!this.sb())return this.pc(a),c.d(b)||(this.ra("verbose")?b({status:-1,error:n}):b(-1)),e;k.log("MIXPANEL PEOPLE REQUEST:");k.log(e);this.e.p(this.ra("api_host")+"/engage/",{data:d},this.e.ta(b,e));return e};p.prototype.ra=function(a){return this.e.c(a)};p.prototype.sb=function(){return this.e.P.$a===m};p.prototype.pc=
function(a){"$set"in a?this.e.persistence.A("$set",a):"$set_once"in a?this.e.persistence.A("$set_once",a):"$add"in a?this.e.persistence.A("$add",a):"$append"in a?this.e.persistence.A("$append",a):"$union"in a?this.e.persistence.A("$union",a):k.error("Invalid call to _enqueue():",a)};p.prototype.sc=function(a,b,d,e,f){var g=this,h=c.extend({},this.e.persistence.R("$set")),i=c.extend({},this.e.persistence.R("$set_once")),k=c.extend({},this.e.persistence.R("$add")),o=this.e.persistence.R("$append"),
q=c.extend({},this.e.persistence.R("$union"));!c.d(h)&&c.j(h)&&!c.V(h)&&(g.e.persistence.S("$set",h),this.set(h,function(b,d){0===b&&g.e.persistence.A("$set",h);c.d(a)||a(b,d)}));!c.d(i)&&c.j(i)&&!c.V(i)&&(g.e.persistence.S("$set_once",i),this.Xb(i,function(a,b){0===a&&g.e.persistence.A("$set_once",i);c.d(e)||e(a,b)}));!c.d(k)&&c.j(k)&&!c.V(k)&&(g.e.persistence.S("$add",k),this.Mb(k,function(a,d){0===a&&g.e.persistence.A("$add",k);c.d(b)||b(a,d)}));!c.d(q)&&c.j(q)&&!c.V(q)&&(g.e.persistence.S("$union",
q),this.bc(q,function(a,b){0===a&&g.e.persistence.A("$union",q);c.d(f)||f(a,b)}));if(!c.d(o)&&c.isArray(o)&&o.length){for(var p,s=function(a,b){0===a&&g.e.persistence.A("$append",p);c.d(d)||d(a,b)},t=o.length-1;0<=t;t--)p=o.pop(),g.append(p,s);g.e.persistence.save()}};p.prototype.$=function(a){return"$distinct_id"===a||"$token"===a};h.lc=function(a,b){c.Cb(this);this.fb=b;this.hb=this.fb.persistence;this.C=c.K(a.id);this.Qb=c.K(a.message_id);this.body=(c.K(a.body)||"").replace(/\n/g,"<br/>");this.Sc=
c.K(a.cta)||"Close";this.fa=c.K(a.type)||"takeover";this.style=c.K(a.style)||"light";this.title=c.K(a.title)||"";this.ka=g.kc;this.X=g.jc;this.da=a.cta_url||n;this.ab=a.image_url||n;this.L=a.thumb_image_url||n;this.Da=a.video_url||n;this.va=m;if(!this.da)this.da="#dismiss",this.va=r;this.u="mini"===this.fa;if(!this.u)this.fa="takeover";this.jd=!this.u?g.Y:g.Ea;this.xb();this.ya=this.zc();this.Cc()};g=h.lc;g.M=200;g.w="mixpanel-notification";g.la=0.6;g.H=25;g.oa=200;g.Y=388;g.Ea=420;g.z=85;g.Fa=5;
g.J=60;g.Ga=Math.round(g.J/2);g.kc=595;g.jc=334;g.prototype.show=function(){var a=this;this.xb();this.q?(this.Bc(),this.Ac(),this.Gc(this.nc)):setTimeout(function(){a.show()},300)};g.prototype.Va=c.l(function(){this.Pb||this.vb({invisible:m});var a=this.vd?this.i("video"):this.Q();if(this.ec)this.Ic("bg","visible"),this.N(a,"exiting"),setTimeout(this.wb,g.M);else{var b,c,e;this.u?(b="right",c=20,e=-100):(b="top",c=g.H,e=g.oa+g.H);this.pa([{s:this.i("bg"),m:"opacity",start:g.la,k:0},{s:a,m:"opacity",
start:1,k:0},{s:a,m:b,start:c,k:e}],g.M,this.wb)}});g.prototype.N=c.l(function(a,b){b=g.w+"-"+b;"string"===typeof a&&(a=this.i(a));a.className?~(" "+a.className+" ").indexOf(" "+b+" ")||(a.className+=" "+b):a.className=b});g.prototype.Ic=c.l(function(a,b){b=g.w+"-"+b;"string"===typeof a&&(a=this.i(a));if(a.className)a.className=(" "+a.className+" ").replace(" "+b+" ","").replace(/^[\s\xA0]+/,"").replace(/[\s\xA0]+$/,"")});g.prototype.pa=c.l(function(a,b,c,e){var f=this,g=r,h,i;h=1*new Date;var k,
e=e||h;k=h-e;for(h=0;h<a.length;h++){i=a[h];if("undefined"===typeof i.G)i.G=i.start;if(i.G!==i.k){var g=m,o=i.k>=i.start?1:-1;i.G=i.start+(i.k-i.start)*k/b;if("opacity"!==i.m)i.G=Math.round(i.G);if(0<o&&i.G>=i.k||0>o&&i.G<=i.k)i.G=i.k}}if(g){for(h=0;h<a.length;h++)i=a[h],i.s&&(i.s.style[i.m]=""+i.G+("opacity"===i.m?"":"px"));setTimeout(function(){f.pa(a,b,c,e)},10)}else c&&c()});g.prototype.nc=c.l(function(){var a=this;if(!this.wd&&!this.rb()[this.C])this.wd=m,this.q.appendChild(this.ga),setTimeout(function(){var b=
a.Q();if(a.ec)a.u||a.N("bg","visible"),a.N(b,"visible"),a.ub();else{var c,e,f;a.u?(c="right",e=-100,f=20):(c="top",e=g.oa+g.H,f=g.H);a.pa([{s:a.i("bg"),m:"opacity",start:0,k:g.la},{s:b,m:"opacity",start:0,k:1},{s:b,m:c,start:e,k:f}],g.M,a.ub)}},100),c.o(a.i("cancel"),"click",function(b){b.preventDefault();a.Va()}),c.o(a.i("button")||a.i("mini-content"),"click",function(b){b.preventDefault();a.W?(a.Ra("$campaign_open",{$resource_type:"video"}),a.Kc()):(a.Va(),a.va&&a.Ra("$campaign_open",{$resource_type:"link"},
function(){window.location.href=a.da}))})});g.prototype.i=function(a){return document.getElementById(g.w+"-"+a)};g.prototype.Q=function(){return this.i(this.fa)};g.prototype.rb=function(){return this.hb.props.__cmpns||(this.hb.props.__cmpns={})};g.prototype.O=function(a,b){return this.B[a]&&this.B[a]<=b};g.prototype.zc=function(){var a=[];this.u?(this.L=this.L||"//cdn.mxpnl.com/site_media/images/icons/notifications/mini-news-dark.png",a.push(this.L)):(this.ab?(a.push(this.ab),this.Kb='<img id="img" src="'+
this.ab+'"/>'):this.Kb="",this.L?(a.push(this.L),this.Zb='<div id="thumbborder-wrapper"><div id="thumbborder"></div></div><img id="thumbnail" src="'+this.L+'" width="'+g.J+'" height="'+g.J+'"/><div id="thumbspacer"></div>'):this.Zb="");return a};g.prototype.Ac=function(){var a="",b="",c="";this.ga=document.createElement("div");this.ga.id=g.w+"-wrapper";if(this.u)a='<div id="mini"><div id="mainbox"><div id="cancel"><div id="cancel-icon"></div></div><div id="mini-content"><div id="mini-icon"><div id="mini-icon-img"></div></div><div id="body"><div id="body-text"><div>'+
this.body+'</div></div></div></div></div><div id="mini-border"></div></div>';else{var a=this.va||this.W?"":'<div id="button-close"></div>',e=this.W?'<div id="button-play"></div>':"";this.O("ie",7)&&(e=a="");a='<div id="takeover">'+this.Zb+'<div id="mainbox"><div id="cancel"><div id="cancel-icon"></div></div><div id="content">'+this.Kb+'<div id="title">'+this.title+'</div><div id="body">'+this.body+'</div><div id="tagline"><a href="http://mixpanel.com?from=inapp" target="_blank">POWERED BY MIXPANEL</a></div></div><div id="button">'+
a+'<a id="button-link" href="'+this.da+'">'+this.Sc+"</a>"+e+"</div></div></div>"}this.gc?(b="//www.youtube.com/embed/"+this.gc+"?wmode=transparent&showinfo=0&modestbranding=0&rel=0&autoplay=1&loop=0&vq=hd1080",this.hc&&(b+="&enablejsapi=1&html5=1&controls=0",c='<div id="video-controls"><div id="video-progress" class="video-progress-el"><div id="video-progress-total" class="video-progress-el"></div><div id="video-elapsed" class="video-progress-el"></div></div><div id="video-time" class="video-progress-el"></div></div>')):
this.fc&&(b="//player.vimeo.com/video/"+this.fc+"?autoplay=1&title=0&byline=0&portrait=0");if(this.W)this.Gd='<iframe id="'+g.w+'-video-frame" width="'+this.ka+'" height="'+this.X+'"  src="'+b+'" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen="1" scrolling="no"></iframe>',c='<div id="video-'+(this.Ya?"":"no")+'flip"><div id="video"><div id="video-holder"></div>'+c+"</div></div>";b=c+a;this.Ya&&(b=(this.u?a:"")+'<div id="flipcontainer"><div id="flipper">'+(this.u?c:b)+"</div></div>");
this.ga.innerHTML=('<div id="overlay" class="'+this.fa+'"><div id="campaignid-'+this.C+'"><div id="bgwrapper"><div id="bg"></div>'+b+"</div></div></div>").replace(/class=\"/g,'class="'+g.w+"-").replace(/id=\"/g,'id="'+g.w+"-")};g.prototype.Bc=function(){this.h="dark"===this.style?{Ta:"#1d1f25",aa:"#282b32",ua:"#3a4147",Bb:"#4a5157",Oc:"#32353c",Fb:"0.4",eb:"#2a3137",Ba:"#fff",ib:"#9498a3",Yb:"#464851",Aa:"#ddd"}:{Ta:"#fff",aa:"#e7eaee",ua:"#eceff3",Bb:"#f5f5f5",Oc:"#e4ecf2",Fb:"1.0",eb:"#fafafa",
Ba:"#5c6578",ib:"#8b949b",Yb:"#ced9e6",Aa:"#7c8598"};var a="0px 0px 35px 0px rgba(45, 49, 56, 0.7)",b=a,d=a,e=g.J+2*g.Fa,f=g.M/1E3+"s";this.u&&(a="none");var j={};j["@media only screen and (max-width: "+(g.Ea+20-1)+"px)"]={"#overlay":{display:"none"}};a={".flipped":{transform:"rotateY(180deg)"},"#overlay":{position:"fixed",top:"0",left:"0",width:"100%",height:"100%",overflow:"auto","text-align":"center","z-index":"10000","font-family":'"Helvetica", "Arial", sans-serif',"-webkit-font-smoothing":"antialiased",
"-moz-osx-font-smoothing":"grayscale"},"#overlay.mini":{height:"0",overflow:"visible"},"#overlay a":{width:"initial",padding:"0","text-decoration":"none","text-transform":"none",color:"inherit"},"#bgwrapper":{position:"relative",width:"100%",height:"100%"},"#bg":{position:"fixed",top:"0",left:"0",width:"100%",height:"100%","min-width":4*this.Wc+"px","min-height":4*this.Vc+"px","background-color":"black",opacity:"0.0","-ms-filter":"progid:DXImageTransform.Microsoft.Alpha(Opacity=60)",filter:"alpha(opacity=60)",
...
top:g.H+"px"},"#takeover.exiting":{opacity:"0.0",top:g.oa+"px"},"#thumbspacer":{height:g.Ga+"px"},"#thumbborder-wrapper":{position:"absolute",top:-g.Fa+"px",left:g.Y/2-g.Ga-g.Fa+"px",width:e+"px",height:e/2+"px",overflow:"hidden"},"#thumbborder":{position:"absolute",width:e+"px",height:e+"px","border-radius":e+"px","background-color":this.h.aa,opacity:"0.5"},"#thumbnail":{position:"absolute",top:"0px",left:g.Y/2-g.Ga+"px",width:g.J+"px",height:g.J+"px",overflow:"hidden","z-index":"100","border-radius":g.J+
"px"},"#mini":{position:"absolute",right:"20px",top:g.H+"px",width:this.jd+"px",height:2*g.z+"px","margin-top":20-g.z+"px","backface-visibility":"hidden",opacity:"0.0",transform:"rotateX(90deg)",transition:"opacity 0.3s, transform 0.3s, right 0.3s"},"#mini.visible":{opacity:"1.0",transform:"rotateX(0deg)"},"#mini.exiting":{opacity:"0.0",right:"-150px"},"#mainbox":{"border-radius":"4px","box-shadow":a,"text-align":"center","background-color":this.h.Ta,"font-size":"14px",color:this.h.ib},"#mini #mainbox":{height:g.z+
"px","margin-top":g.z+"px","border-radius":"3px",transition:"background-color "+f},"#mini-border":{height:g.z+6+"px",width:g.Ea+6+"px",position:"absolute",top:"-3px",left:"-3px","margin-top":g.z+"px","border-radius":"6px",opacity:"0.25","background-color":"#fff","z-index":"-1","box-shadow":d},"#mini-icon":{position:"relative",display:"inline-block",width:"75px",height:g.z+"px","border-radius":"3px 0 0 3px","background-color":this.h.aa,background:"linear-gradient(135deg, "+this.h.Bb+" 0%, "+this.h.aa+
" 100%)",transition:"background-color "+f},"#mini:hover #mini-icon":{"background-color":this.h.eb},"#mini:hover #mainbox":{"background-color":this.h.eb},"#mini-icon-img":{position:"absolute","background-image":"url("+this.L+")",width:"48px",height:"48px",top:"20px",left:"12px"},"#content":{padding:"30px 20px 0px 20px"},"#mini-content":{"text-align":"left",height:g.z+"px",cursor:"pointer"},"#img":{width:"328px","margin-top":"30px","border-radius":"5px"},"#title":{"max-height":"600px",overflow:"hidden",
"word-wrap":"break-word",padding:"25px 0px 20px 0px","font-size":"19px","font-weight":"bold",color:this.h.Ba},"#body":{"max-height":"600px","margin-bottom":"25px",overflow:"hidden","word-wrap":"break-word","line-height":"21px","font-size":"15px","font-weight":"normal","text-align":"left"},"#mini #body":{display:"inline-block","max-width":"250px",margin:"0 0 0 30px",height:g.z+"px","font-size":"16px","letter-spacing":"0.8px",color:this.h.Ba},"#mini #body-text":{display:"table",height:g.z+"px"},"#mini #body-text div":{display:"table-cell",
"vertical-align":"middle"},"#tagline":{"margin-bottom":"15px","font-size":"10px","font-weight":"600","letter-spacing":"0.8px",color:"#ccd7e0","text-align":"left"},"#tagline a":{color:this.h.Yb,transition:"color "+f},"#tagline a:hover":{color:this.h.Aa},"#cancel":{position:"absolute",right:"0",width:"8px",height:"8px",padding:"10px","border-radius":"20px",margin:"12px 12px 0 0","box-sizing":"content-box",cursor:"pointer",transition:"background-color "+f},"#mini #cancel":{margin:"7px 7px 0 0"},"#cancel-icon":{width:"8px",
height:"8px",overflow:"hidden","background-image":"url(//cdn.mxpnl.com/site_media/images/icons/notifications/cancel-x.png)",opacity:this.h.Fb},"#cancel:hover":{"background-color":this.h.ua},"#button":{display:"block",height:"60px","line-height":"60px","text-align":"center","background-color":this.h.aa,"border-radius":"0 0 4px 4px",overflow:"hidden",cursor:"pointer",transition:"background-color "+f},"#button-close":{display:"inline-block",width:"9px",height:"60px","margin-right":"8px","vertical-align":"top",
...
"font-size":"17px","font-weight":"bold",overflow:"hidden","word-wrap":"break-word",color:this.h.Ba,transition:"color "+f},"#button:hover":{"background-color":this.h.ua,color:this.h.Aa},"#button:hover a":{color:this.h.Aa},"#video-noflip":{position:"relative",top:2*-this.X+"px"},"#video-flip":{"backface-visibility":"hidden",transform:"rotateY(180deg)"},"#video":{position:"absolute",width:this.ka-1+"px",height:this.X+"px",top:g.H+"px","margin-top":"100px",left:"50%","margin-left":Math.round(-this.ka/
2)+"px",overflow:"hidden","border-radius":"5px","box-shadow":b,transform:"translateZ(1px)",transition:"opacity "+f+", top "+f},"#video.exiting":{opacity:"0.0",top:this.X+"px"},"#video-holder":{position:"absolute",width:this.ka-1+"px",height:this.X+"px",overflow:"hidden","border-radius":"5px"},"#video-frame":{"margin-left":"-1px",width:this.ka+"px"},"#video-controls":{opacity:"0",transition:"opacity 0.5s"},"#video:hover #video-controls":{opacity:"1.0"},"#video .video-progress-el":{position:"absolute",
bottom:"0",height:"25px","border-radius":"0 0 0 5px"},"#video-progress":{width:"90%"},"#video-progress-total":{width:"100%","background-color":this.h.Ta,opacity:"0.7"},"#video-elapsed":{width:"0","background-color":"#6cb6f5",opacity:"0.9"},"#video #video-time":{width:"10%",right:"0","font-size":"11px","line-height":"25px",color:this.h.ib,"background-color":"#666","border-radius":"0 0 5px 0"}};this.O("ie",8)&&c.extend(a,{"* html #overlay":{position:"absolute"},"* html #bg":{position:"absolute"},"html, body":{height:"100%"}});
this.O("ie",7)&&c.extend(a,{"#mini #body":{display:"inline",zoom:"1",border:"1px solid "+this.h.ua},"#mini #body-text":{padding:"20px"},"#mini #mini-icon":{display:"none"}});var b="backface-visibility,border-radius,box-shadow,opacity,perspective,transform,transform-style,transition".split(","),d=["khtml","moz","ms","o","webkit"],h;for(h in a)for(e=0;e<b.length;e++)if(f=b[e],f in a[h])for(var i=a[h][f],k=0;k<d.length;k++)a[h]["-"+d[k]+"-"+f]=i;(function(a,b){function c(a){var b="",d;for(d in a){var e=
d.replace(/#/g,"#"+g.w+"-").replace(/\./g,"."+g.w+"-"),b=b+("\n"+e+" {"),e=a[d],f;for(f in e)b+=f+":"+e[f]+";";b+="}"}return b}var d=c(a)+function(a){var b="",d;for(d in a)b+="\n"+d+" {"+c(a[d])+"\n}";return b}(b),f=document.head||document.getElementsByTagName("head")[0]||document.documentElement,e=document.createElement("style");f.appendChild(e);e.setAttribute("type","text/css");e.styleSheet?e.styleSheet.cssText=d:e.textContent=d})(a,j)};g.prototype.Cc=c.l(function(){if(this.Da){var a=this;a.hc=
"postMessage"in window;a.da=a.Da;var b=a.Da.match(/(?:youtube(?:-nocookie)?\.com\/(?:[^\/]+\/.+\/|(?:v|e(?:mbed)?)\/|.*[?&]v=)|youtu\.be\/)([^"&?\/ ]{11})/i),c=a.Da.match(/vimeo\.com\/.*?(\d+)/i);if(b){if(a.W=m,a.gc=b[1],a.hc)window.onYouTubeIframeAPIReady=function(){a.i("video-frame")&&a.zb()},b=document.createElement("script"),b.src="//www.youtube.com/iframe_api",c=document.getElementsByTagName("script")[0],c.parentNode.insertBefore(b,c)}else if(c)a.W=m,a.fc=c[1];if(a.O("ie",7)||a.O("firefox",3))a.W=
r,a.va=m}});g.prototype.ub=c.l(function(){function a(a,b){var c={};if(document.defaultView&&document.defaultView.getComputedStyle)c=document.defaultView.getComputedStyle(a,n);else if(a.currentStyle)c=a.currentStyle;return c[b]}var b=this;c.o(b.i("bg"),"click",function(){b.Va()});if(this.C){var d=this.i("overlay");d&&"hidden"!==a(d,"visibility")&&"none"!==a(d,"display")&&this.vb()}});g.prototype.vb=c.l(function(a){if(!this.Pb)this.Pb=m,this.C&&(this.rb()[this.C]=1*new Date,this.hb.save()),this.Ra("$campaign_delivery",
a),this.fb.people.append({$campaigns:this.C,$notifications:{campaign_id:this.C,message_id:this.Qb,type:"web",time:new Date}})});g.prototype.Gc=function(a){var b=this;if(0===this.ya.length)a();else{for(var c=0,e=[],f=function(){c++;c===b.ya.length&&a&&(a(),a=n)},g=0;g<this.ya.length;g++){var h=new Image;h.onload=f;h.src=this.ya[g];h.complete&&f();e.push(h)}this.O("ie",7)&&setTimeout(function(){var b=m;for(g=0;g<e.length;g++)e[g].complete||(b=r);b&&a&&(a(),a=n)},500)}};g.prototype.wb=c.l(function(){window.clearInterval(this.Mc);
this.ga.style.visibility="hidden";this.q.removeChild(this.ga)});g.prototype.xb=function(){function a(a){if(a in e)return m;if(!c)for(var a=a[0].toUpperCase()+a.slice(1),a=["O"+a,"Webkit"+a,"Moz"+a],b=0;b<a.length;b++)if(a[b]in e)return m;return r}function b(a){return(a=navigator.userAgent.match(a))&&a[1]}this.B={};this.B.chrome=b(/Chrome\/(\d+)/);this.B.firefox=b(/Firefox\/(\d+)/);this.B.ie=b(/MSIE (\d+).+/);!this.B.ie&&!window.ActiveXObject&&"ActiveXObject"in window&&(this.B.ie=11);if(this.q=document.body||
document.getElementsByTagName("body")[0])this.Wc=Math.max(this.q.scrollWidth,document.documentElement.scrollWidth,this.q.offsetWidth,document.documentElement.offsetWidth,this.q.clientWidth,document.documentElement.clientWidth),this.Vc=Math.max(this.q.scrollHeight,document.documentElement.scrollHeight,this.q.offsetHeight,document.documentElement.offsetHeight,this.q.clientHeight,document.documentElement.clientHeight);var c=this.B.ie,e=document.createElement("div").style;this.ec=this.q&&a("transition")&&
a("transform");this.Ya=(33<=this.B.chrome||15<=this.B.firefox)&&this.q&&a("backfaceVisibility")&&a("perspective")&&a("transform")};g.prototype.Kc=c.l(function(){function a(){window.YT&&window.YT.loaded&&b.zb();b.vd=m;b.Q().style.visibility="hidden"}var b=this,c=[{s:b.Q(),m:"opacity",start:1,k:0},{s:b.Q(),m:"top",start:g.H,k:-500},{s:b.i("video-noflip"),m:"opacity",start:0,k:1},{s:b.i("video-noflip"),m:"top",start:2*-b.X,k:0}];if(b.u){var e=b.i("bg"),f=b.i("overlay");e.style.width="100%";e.style.height=
"100%";f.style.width="100%";b.N(b.Q(),"exiting");b.N(e,"visible");c.push({s:b.i("bg"),m:"opacity",start:0,k:g.la})}b.i("video-holder").innerHTML=b.Gd;b.Ya?(b.N("flipper","flipped"),setTimeout(a,g.M)):b.pa(c,g.M,a)});g.prototype.Ra=function(a,b,d){this.C?(b=b||{},b=c.extend(b,{campaign_id:this.C,message_id:this.Qb,message_type:"web_inapp",message_subtype:this.fa}),this.fb.track(a,b,d)):d&&d.call()};g.prototype.zb=c.l(function(){var a=this;if(!a.Hd){a.Hd=m;var b=a.i("video-elapsed"),d=a.i("video-time"),
e=a.i("video-progress");new window.YT.Player(g.w+"-video-frame",{events:{onReady:function(f){function g(a){var a=Math.round(i-a),b=Math.floor(a/60),c=Math.floor(b/60),a=a-60*b;d.innerHTML="-"+(c?c+":":"")+("00"+(b-60*c)).slice(-2)+":"+("00"+a).slice(-2)}var h=f.target,i=h.getDuration();g(0);a.Mc=window.setInterval(function(){var a=h.getCurrentTime();b.style.width=100*(a/i)+"%";g(a)},250);c.o(e,"click",function(a){a=Math.max(0,a.pageX-e.getBoundingClientRect().left);h.seekTo(i*a/e.clientWidth,m)})}}})}});
h.prototype.init=h.prototype.U;h.prototype.reset=h.prototype.reset;h.prototype.disable=h.prototype.disable;h.prototype.time_event=h.prototype.yd;h.prototype.track=h.prototype.I;h.prototype.track_links=h.prototype.Bd;h.prototype.track_forms=h.prototype.Ad;h.prototype.track_pageview=h.prototype.ac;h.prototype.register=h.prototype.ia;h.prototype.register_once=h.prototype.F;h.prototype.unregister=h.prototype.Ca;h.prototype.identify=h.prototype.Za;h.prototype.alias=h.prototype.Nc;h.prototype.name_tag=
h.prototype.hd;h.prototype.set_config=h.prototype.Wb;h.prototype.get_config=h.prototype.c;h.prototype.get_property=h.prototype.xa;h.prototype.get_distinct_id=h.prototype.T;h.prototype.toString=h.prototype.toString;h.prototype._check_and_handle_notifications=h.prototype.lb;h.prototype._show_notification=h.prototype.yb;o.prototype.properties=o.prototype.ha;o.prototype.update_search_keyword=o.prototype.dc;o.prototype.update_referrer_info=o.prototype.jb;o.prototype.get_cross_subdomain=o.prototype.ad;
o.prototype.clear=o.prototype.clear;p.prototype.set=p.prototype.set;p.prototype.set_once=p.prototype.Xb;p.prototype.increment=p.prototype.Mb;p.prototype.append=p.prototype.append;p.prototype.union=p.prototype.bc;p.prototype.track_charge=p.prototype.zd;p.prototype.clear_charges=p.prototype.Rc;p.prototype.delete_user=p.prototype.Tc;p.prototype.toString=p.prototype.toString;c.nd(h);var y={};(function(){L=1;s=window.mixpanel;c.d(s)?k.ca('"mixpanel" object not initialized. Ensure you are using the latest version of the Mixpanel JS Library along with the snippet we provide.'):
s.__loaded||s.config&&s.persistence?k.error("Mixpanel library has already been downloaded at least once."):1.1>(s.__SV||0)?k.ca("Version mismatch; please ensure you're using the latest version of the Mixpanel code snippet."):(c.a(s._i,function(a){a&&c.isArray(a)&&(y[a[a.length-1]]=H.apply(this,a))}),W(),s.init(),c.a(y,function(a){a.sa()}),V())})()})();
})();
